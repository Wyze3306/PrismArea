...
namespace PrismArea\libs\muqsit\invmenu;

use Closure;
use PrismArea\libs\muqsit\invmenu\inventory\SharedInvMenuSynchronizer;
use PrismArea\libs\muqsit\invmenu\session\InvMenuInfo;
use PrismArea\libs\muqsit\invmenu\session\PlayerWindowDispatcher;
use PrismArea\libs\muqsit\invmenu\transaction\DeterministicInvMenuTransaction;
...
use PrismArea\libs\muqsit\invmenu\transaction\SimpleInvMenuTransaction;
...
class InvMenu implements InvMenuTypeIds{
	...
	/**
	 * @return (Closure(\PrismArea\libs\muqsit\invmenu\transaction\InvMenuTransaction) : InvMenuTransactionResult)|null
	 */
