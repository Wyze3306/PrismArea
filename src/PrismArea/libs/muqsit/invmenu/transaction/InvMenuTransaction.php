...
namespace PrismArea\libs\muqsit\invmenu\transaction;
...
interface InvMenuTransaction{
	 ...
	 *
	 * @return Item
     * @link \muqsit\playervaults\libs\muqsit\invmenu\transaction\InvMenuTransaction::getOut()
	 */
	 ...
	 *
	 * @return Item
     * @link \muqsit\playervaults\libs\muqsit\invmenu\transaction\InvMenuTransaction::getIn()
	 */
